<?php
	...
	if(empty($_POST['pg_post_name'])) {
		$contest = intval($_GET['contest_id']); 
...
<html lang="en">
<head>
	<title>TOP SCORE Create Lineup</title>
	<meta charset="utf-8">
	...
	<div class="container mw-100 px-5 py-3" style="min-width:1130px;">
		...
		<div class= "row mb-5">
			...
			<div class = "col-sm-3 pl-0">
				<h3 class="text-center font-bold mb-3" style="color:black">Create Lineup</h3>			
			</div>
		...
		<?php
			if($_SERVER['REQUEST_METHOD'] == 'POST') {	
				...
				require('requires/process-create-lineup.php');						
			}	
		?>
		...
		<div class="row bg-white ml-2" style="height:25px;" >
			...
			<input type="button" class="text-white border border-dark bg-dark text-center" id="clear_search" name="clear_search"
				   value = "X" style="width:40px;">  <!-- btn gray-btn border border-dark form-control -->
		</div>
		...
		<div class= "row mb-0 mt-4">				
			...
			<table id="salary-table" class="border border-dark col-sm-4 pl-0 pr-0 m-0 ml-4">
				<tr class="text-white bg-dark mb-0" style="width:100%; height:30px; font-size:14px;">
					<th class= "p-0 pl-2 font-weight-bold text-right" scope = "col" style="min-width:90px; font-size:17px;">LINEUP</th>
					<th class= "p-0 pl-2  text-right font-weight-light" scope = "col" style="min-width:130px;">Avg. Rem./Player:</th>
					<th class= "p-0 pl-2 green" name="sal_avg" id="sal_avg" scope = "col" style="min-width:80px;">&#36;6,250</th>
					...
					<th class= "p-0 green" name="sal_remain" id="sal_remain" scope = "col" 
						style="min-width:105px; width:100%;">&#36;50,000</th>							
				</tr>												
		...
		<div class= "row mb-5 mt-0">
			<table class="col-sm-6 pl-0 pr-0"  id="select-table" style="margin: 0px; 
						display:block; max-height:300px; overflow-y:auto; overflow-x:auto;"> 
				...
				<?php
					try{
					    ...
					    if($result && (mysqli_num_rows($result) >= 1)) {
							...
							if ($_SERVER['REQUEST_METHOD'] == 'POST') {
								echo '<script>
									$( document ).ready(function() {
											...
											// clear out default values of $6,250 and $50,000 that pre-loaded
											sal_row.cells[2].innerHTML = "";
											sal_row.cells[4].innerHTML = "";
							...
							//echo'<p class="text-center"> No Players found for contest selected.</p>';		
							echo'<script>
									var cust_alert = new CustomAlert();
									cust_alert.render("No Players found for the contest selected.");
								 </script>';	
							exit();
						}																				
					}						
				...
				<form class ="pl-0 pr-0 m-0" id="lineup_form" name="lineup_form" 
					...
					<table class="pl-0 pr-0 m-0" id="lineup-table"> 
						...
						<tbody>	
							<tr class="text-nowrap" style="background-color:white; height:20px;">
								<td class= "px-2 border border-dark" name="pg_id" id="pg_id" style="display:none;"></td>
							...
							<tr class="text-nowrap" style="background-color:white; height:20px;">
								<td class= "px-2 border border-dark" name="sg_id" id="sg_id" style="display:none;"></td>
								<td class= "px-2 border border-dark" style="display:none;"></td>
								<td class= "px-2 border border-dark" style="display:none;"></td>
							...
							<tr class="text-nowrap" style="background-color:white; height:20px;">
								<td class= "px-2 border border-dark" name="sf_id" id="sf_id" style="display:none;"></td>
								<td class= "px-2 border border-dark" style="display:none;"></td>
								<td class= "px-2 border border-dark" style="display:none;"></td>
							...
							<tr class="text-nowrap" style="background-color:white; height:20px;">
								<td class= "px-2 border border-dark" name="pf_id" id="pf_id" style="display:none;"></td>
								<td class= "px-2 border border-dark" style="display:none;"></td>
								<td class= "px-2 border border-dark" style="display:none;"></td>
							...
							<tr class="text-nowrap" style="background-color:white; height:20px;">
								<td class= "px-2 border border-dark" name="c_id" id="c_id" style="display:none;"></td>
								<td class= "px-2 border border-dark" style="display:none;"></td>
								<td class= "px-2 border border-dark" style="display:none;"></td>
							...
							<tr class="text-nowrap" style="background-color:white; height:20px;">
								<td class= "px-2 border border-dark" name="g_id" id="g_id" style="display:none;"></td>
								<td class= "px-2 border border-dark" style="display:none;"></td>
								<td class= "px-2 border border-dark" style="display:none;"></td>
							...
							<tr class="text-nowrap" style="background-color:white; height:20px;">
								<td class= "px-2 border border-dark" name="f_id" id="f_id" style="display:none;"></td>
								<td class= "px-2 border border-dark" style="display:none;"></td>
								<td class= "px-2 border border-dark" style="display:none;"></td>
							...
							<tr class="text-nowrap" style="background-color:white; height:20px;">
								<td class= "px-2 border border-dark" name="util_id" id="util_id" style="display:none;"></td>
								<td class= "px-2 border border-dark" style="display:none;"></td>
								<td class= "px-2 border border-dark" style="display:none;"></td>
							...
							<tr class="border border-dark text-nowrap" style="background-color:white; height:20px;">
								...
								<td class= "text-center" name="fpts_total" id="fpts_total"
									style="border-left: 1px solid black;">0.0</td>
					...
					<div class="mt-3 pt-2 text-center">	
						...
						<button type="button"  class="lineup_btn ml-4 text-center"  id="lineup_save_btn" 
								onclick="save_lineup();" >Save Lineup</button>
			...
			<script>
				function add_pg(pg_id) {
					...
					var table = document.getElementById("lineup-table");					
					var row = table.rows[1];	
					var pts_row = table.rows[9];
						...
						if(pg_id == pg_array[i]["id"]) {
							...
							if(row.cells[0].innerHTML == "") {
								...
								if(sal <= 0) 
									...
									// will always be 7 because this area of code only gets
									// implemented until user clicks on a position button
									var rem_picks = 7;
